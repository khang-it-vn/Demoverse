...
var MyApp = (function () {
  ...
  function event_process_for_signaling_server() {
    ...
    socket.on("inform_others_about_me", function (data) {
      addUser(data.other_user_id,data.user_name, data.connId, data.userNumber);
    ...
    socket.on("showFileMessage", function (data) {
      ...
      attachFileAreaForOther.innerHTML +=
        "<div class='left-align' style='display:flex; align-items:center;'><img src='../images/other.jpg' style='height:40px;width:40px;' class='caller-image circle'><div style='font-weight:600;margin:0 5px;'>" +
        data.username +
  ...
  function addUser(other_user_id,user_name, connId, userNum) {
    var newDivId = $("#otherTemplate").clone();
    newDivId = newDivId.attr("id", connId).addClass("other");
    newDivId.find("h2").text(user_name);
