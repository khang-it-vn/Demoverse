                            ...
                            if(t.id_Topic == ${mainTopic.id_Topic})
                            {
                                ...
                                rooms.forEach(r => {
                                    if(r.id_Type == t.id && r.state )
                                    {
                                        ...
                                        div_room.removeClass("catetogory").addClass("btn");
                                        div_room.text("Phòng "+so_Phong);
                                        so_Phong++;
    ...
    <div style="border: 5px solid black;display: none">
        <nav style="display: flex; position: relative;">
            <ul style="float: left;"  id="main">
                <li class="catetogory" style="border: 1px solid black; display: inline; margin-right: 5px; margin-left: 5px; align-items: center">toan 1 phong 1</li>
            </ul>
        </nav>
    </div>
